            ...
            <%            
                ...
                try {
                    ...
                    if (txtCourse != null) {
                        ...
                        Dataset dataset = DB.SVMClassifer.loadDataSetForPlacement();
                        ...
                        for (Instance inst : datasetTest) {
                            ...
                            if (pred==0.0) {
                                output = "Placement will like be <b>On campus</b>";
                            } else if (pred==1.0) {
                                output = "Placement will like be <b>Off campus</b>";
                            } else if (pred==2.0) {
                                output = "Placement will like be of type <b>others</b>";
                            }
                        }
