        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    %>
                    <form class="form-inline my-2 my-lg-0 mr-lg-2"  action="analyzeData.jsp" method="post">
                        ...
                        <select class="form-dropdown" name="txtBatch2" required>
            ...
            <%
                try {
                    ...
                    if (batch1 != null) {
                        ...
                        String sql2 = "select count(placement_type) from tblData where batch='" + batch1 + "' and placement_type='0'";
                        String sql3 = "select count(placement_type) from tblData where batch='" + batch2 + "' and placement_type='1'";
