            ...
            <%            
                ...
                try {
                    ...
                    if (txtCourse != null) {
                        ...
                        Dataset dataset = DB.SVMClassifer.loadDataSetForFurtherStudies();
                        ...
                        for (Instance inst : datasetTest) {
                          ...
                          /*
                            ...
                            */
                            ...
                            if (pred==1.0) {
                                output = "Further study will like be <b>MSC</b>";
                            } else if (pred==2.0) {
                                output = "Further study will like be <b>MBA</b>";
                            } else if (pred==3.0) {
                                output = "Further study will like be of type <b>JOB</b>";
                            
                            } else if (pred==4.0) {
                                output = "Further study will like be of type <b>others</b>";
                            }
                        }
